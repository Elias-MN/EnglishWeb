import { INDEXDB_NAME, INDEXDB_VERSION, STORE_NAME, STORE_DIARY } from "./constants.js";
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onupgradeneeded = (event) => {
        ...
        if (!db.objectStoreNames.contains(STORE_DIARY)) {
          const objectStore = db.createObjectStore(STORE_DIARY, { keyPath: 'id', autoIncrement: true });
        }
      };
